...
import com.example.sqllitepoo.MainActivity;
import com.example.sqllitepoo.R;
        ...
        public void onClick(View view) {
            ...
            if (validarInput){
                ...
                if (conexion.cosultCod(datos) == true){
                    ...
                    Toast.makeText(context,"No se encuentran los resultados",Toast.LENGTH_SHORT).show();
                }
            }else {
